...
export default function EditSet() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!title || flashcards.length === 0 || !set) return;
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h2 className="text-3xl font-bold mb-8">Edit Flashcard Set</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-gray-800 p-6 rounded-lg">
          <h3 className="text-xl font-semibold mb-4">Generate New Flashcards with AI</h3>
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xl font-semibold">Current Flashcards</h3>
            {topic && (
              <button
                type="button"
                onClick={handleGenerate}
